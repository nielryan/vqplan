...
$shape->getAlignment()->setHorizontal( PHPPowerPoint_Style]Alignment::HORIZONTAL_LEFT );
...
echo '<meta http-equiv="Refresh" Content="4; URL=http://vqplan.com/ppt/'.$theFileName.'">';
